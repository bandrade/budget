...
@Named
@SessionScoped
public class StatusBudgetAction implements Serializable {
	...
	public void pesquisar()
	{
		...
		try {
			tarefas = bpmsTask.obterTarefasProcesso(areaSelecionada, centroCustoSelecionado, ProcessType.BUDGET);
		} catch (Exception e) {
