...
@Named
@SessionScoped
public class StatusSolicitacaoPagamentoAction implements Serializable {
	...
	public void pesquisar()
	{
		...
		try {
			tarefas = bpmsTask.obterTarefasProcessoSolicitacaoPagamento(de,ate,areaSelecionada, centroCustoSelecionado, ProcessType.SOLICITACAO_PAGAMENTO);
		} catch (Exception e) {
